...
while true; do
  ...
  if [[ $(( RANDOM % ${CHANCE} )) -eq 0 ]]; then aws --endpoint-url ${EPURL} s3api put-bucket-versioning --bucket redhat_testing_bucket_bea48dac-e74a-11e8-8d41-f85971b8e3ef --versioning-configuration Status=Suspended ; fi
